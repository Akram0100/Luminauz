  ...
  return (
    ...
    >
      <Card className="overflow-hidden border-2 border-red-500/30 hover:border-red-500 transition-all bg-gradient-to-b from-background to-red-500/5">
        ...
        <Link href={`/product/${product.slug?.trim() || product.id}`} data-testid={`link-flash-sale-${product.id}`}>
        ...
        <CardContent className="p-5 space-y-4">
          ...
          <div className="flex gap-3">
            ...
            <Button variant="outline" asChild>
              <Link href={`/product/${product.slug?.trim() || product.id}`} data-testid={`link-details-${product.id}`}>
